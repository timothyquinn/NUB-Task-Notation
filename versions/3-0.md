# NUB Task Notation Version 3.0

For an overview of NUB Task Notation, see the [README](../README.md).

## Changelog

- The ? stoplight has been replaced with the symbol ^ for clarity
- The % stoplight has been added
- The example usage of the ID stoplight has been improved
- All value indicators are now bidirectional
...
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ! | The task cannot NOT happen. Declaring a task mandatory is an explicit declaration, rather than an implicit assumption. |
...
| % | The task is in progress, and you wish to differentiate it visually so that triaging unstarted tasks is easier. |
...
| +q | Because there are tasks whose value cannot be expressed in money or time, a "+q" indicates a quality of life gain (and a "-q" indicates a quality of life loss). |
...
| Notation | Description |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| #1 | A number sign denotes a unique identifier or ID for this task which can be referenced either elsewhere in the task list (see predecessor attribute below) or outside of the task list. |
